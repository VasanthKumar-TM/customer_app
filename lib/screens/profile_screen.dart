...
import 'package:customer_app/models/payment_method.dart';
...
import 'package:customer_app/widgets/info_card.dart';
import 'package:customer_app/widgets/radio_group.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  TextEditingController _profilePhoneController = TextEditingController();
  ...
  void _toggleUpdate() {
    setState(() {
      ...
      _profilePhoneController.text = profile.mobile;
  ...
  Widget _buildProfilePhone(TextTheme textTheme, Profile profile) {
    if (_update) {
      return Container(
        height: Sizes.SIZE_30,
        padding: const EdgeInsets.only(
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: Sizes.SIZE_8),
                          _buildProfilePhone(textTheme, profile),
                          SizedBox(height: Sizes.SIZE_8),
